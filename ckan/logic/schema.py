...
def default_user_schema(
        ...
        json_object: Validator, limit_sysadmin_update: Validator):
    return cast(Schema, {
        'id': [ignore_missing, unicode_safe],
        'name': [
...
def default_create_resource_view_schema_unfiltered(
        ...
        unicode_safe: Validator, ignore_missing: Validator, keep_extras: Validator):
    return cast(Schema, {
        'resource_id': [not_empty, resource_id_exists],
        'title': [not_empty, unicode_safe],
        'description': [ignore_missing, unicode_safe],
        'view_type': [not_empty, unicode_safe],
        '__extras': [keep_extras],  # (canada fork only): keep extras for resource views
    })
